      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
          					<button type="button" id="delbttn" class="btn btn-outline" data-dismiss="modal">OK</button>
...
<!-- Modal -->
        ...
        <section class="content">
			...
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Job Posted by you</h3>
                  <div class="box-tools">
    ...
    <script src="js/view/view-jobs-view.js"></script>
